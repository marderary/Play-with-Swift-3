...
// 获取最小，最大值
///swift3 中minElement()和maxElement()被简化为min()和max()
//numbers.minElement()
//vowels.maxElement()

/// swift 3 中对方法名进行了简化，直接用min(),max()可获取最小最大值
numbers.min()
vowels.max()
...
///swift3 中对对很多带介词的方法，通过强制显示第一个参数的形式把“介词”内置为显示的参数
vowels.index(of: "E")
...
///swift3 中数组enumerate() 修改为enumerated()
